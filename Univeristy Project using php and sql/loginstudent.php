      ...
      <div class="form-box login">
        ...
        transition: 0.4s; padding: 40px;">
          ...
          if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare("SELECT * FROM students WHERE StudentNo = ? AND Password = ?");
            ...
            if ($result->num_rows == 1) {
              ...
              $_SESSION['name'] = $row['FirstName']; // Assuming 'FirstName' is the column name in your 'students' table
              $_SESSION['id'] = $row['StudentID']; // Assuming 'StudentID' is the column name in your 'students' table
              header("Location: studentdash.php");
              exit();
            } else {
              echo "<script>alert('Please enter your correct details')</script>";
              echo "<script>window.open('loginstudent.php','_self')</script>";
            }
          }
