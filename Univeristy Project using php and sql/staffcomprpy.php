...
<body>
    ...
    <div class="container">
        <div class="cardd">
            <div class="card-body">
                <h2>Respond to Student Complaints </h2>
            </div>
            <div class="card-body">
                <form class="form-group" action="staff_comp_reply.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="enq_msg" class="form-control" value="<?php echo $msg; ?>" readonly><br>

                    <label>Send Reply</label>
                    <input type="textarea" name="msg" class="form-control" style="height: 60px;">


                    <center> <input type="submit" name="staff_reply" value="Submit Reply" class="btn btn-warning"></center>
